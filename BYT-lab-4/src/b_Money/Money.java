...
public class Money implements Comparable {
	...
	public Double getAmount() {
		return (Double) (double)(this.amount) ;
	}
	...
	public String toString() {
		return this.getAmount()/100 + " " + this.getCurrency().getName();
	}
	...
	public Money add(Money other) {
		var otherAmount = this.currency.valueInThisCurrency(other.amount, other.currency);
	...
	public Money sub(Money other) {
		var otherAmount = this.getCurrency().valueInThisCurrency(other.amount, other.currency);
		return new Money(this.amount - otherAmount, this.currency);
	}
	...
	public int compareTo(Object other) {
		...
		var moneyComparison = this.sub(otherMoney);

		if(moneyComparison.amount != 0) {
			return moneyComparison.amount > 0? 1:-1;
		} else {
			return 0;
		}
	}
